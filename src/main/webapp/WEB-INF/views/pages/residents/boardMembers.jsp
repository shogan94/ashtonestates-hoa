			...
			<div class="row">
				<div class="col-md-6 text-center center-block">
					<div class="contactInfo">
						...
						<ul class="list-group">
							<li class="list-group-item"><span class="badge"><a href="mailto:jeffreywayne3@yahoo.com"><span class="glyphicon glyphicon-envelope"></span></a></span>President - Jeff
								Dalrymple</li>
							<li class="list-group-item"><span class="badge"><a href="mailto:morgantown255@hotmail.com"><span class="glyphicon glyphicon-envelope"></span></a></span>VicePresident -
								Michael Kief</li>
							<li class="list-group-item"><span class="badge"><a href="mailto:hawk1218@yahoo.com"><span class="glyphicon glyphicon-envelope"></span></a></span>Secretary - Brenda
								Hawkins</li>
