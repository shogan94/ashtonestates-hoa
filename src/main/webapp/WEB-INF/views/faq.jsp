							...
							<div class="col-md-12">
								<div class="content">
									...
									<dl id="faqs">
										...
										<dd>
											The Declaration of Covenants are the <span style="color: #333333;"><strong>governing documents</strong></span> of our association. This document gives the association
											its power and authority and is recoded against each lot. The owner of each lot is therefore subject to the terms and conditions it contains. It is the guideline that all
											community operations follow.
										</dd>
										...
										<dd>
											...
											to purchase a home for sale. Given this, our homeowner's contact list is distributed only to current homeowners. The list is automatically created from this websites
											Registered users and it can be downloaded from the <span style="color: #333333;"><strong><a style="color: #333333;" title="Residents Only"
													href="${residents}">Residents Only</a></strong></span> section after successful login to the website.
										</dd>
									</dl>
								</div>
							</div>
